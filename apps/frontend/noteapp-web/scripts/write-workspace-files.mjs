...
const outputPath = process.env.NOTEAPP_WORKSPACE_FILES_OUTPUT
  ? resolve(process.env.NOTEAPP_WORKSPACE_FILES_OUTPUT)
  : resolve(appRoot, 'public', 'fixtures', 'workspace-files.json');
...
function printHelp() {
  console.log(`write-workspace-files

Generate public/fixtures/workspace-files.json from the desktop sync CLI.
...
Optional environment:
  ...
  NOTEAPP_WORKSPACE_FILES_OUTPUT
                          Output JSON path, default public/fixtures/workspace-files.json
...
function buildCommand() {
  ...
  commandArgs.push('workspace-files');
