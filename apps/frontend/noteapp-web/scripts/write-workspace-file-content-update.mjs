...
const inputPath = process.env.NOTEAPP_WORKSPACE_FILE_TEXT_INPUT
  ? resolve(process.env.NOTEAPP_WORKSPACE_FILE_TEXT_INPUT)
  : '';
...
function printHelp() {
  console.log(`write-workspace-file-content-update

Write one workspace file through the desktop sync CLI and refresh the content fixture.
...
Required environment:
  ...
  NOTEAPP_WORKSPACE_FILE_ID             File id to write
  NOTEAPP_WORKSPACE_FILE_TEXT_INPUT     UTF-8 text file containing the new content
...
function buildCommand() {
  ...
  commandArgs.push(
    ...
    '--input-text-file',
    requireEnv('NOTEAPP_WORKSPACE_FILE_TEXT_INPUT'),
  );
